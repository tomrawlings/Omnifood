...
<head>
    ...
    <meta name="dexcription" content="Ominfood is a premium food deleivery service with the mission to bring affordable and healthy meals to as many people as possible.">
...
<body>
        ...
        <nav>
            <div class="row">
                ...
                <ul class="main-nav js-main-nav">
                    <li><a href="#features" class="">Food delivery</a></li>
                    <li><a href="#works" class="">How it works</a></li>
                    <li><a href="#cities" class="">Our cities</a></li>
                    <li><a href="#plans" class="">Sign up</a></li>
                    <li><a href="#contact" class="">Contact</a></li>
                </ul>
                <a class="mobile-nav-icon js-nav-icon"><i class="ion-ios-menu js-nav-icon-i"></i></a>
            </div>
        </nav>
        <div class="hero-text-box">
            <h1>Goodbye junk food.<br>super healthy meals.</h1>
    ...
    <script src="vendors/scripts/Respond-master/dest/respond.min.js"></script>
    <script src="vendors/scripts/html5shiv-master/dist/html5shiv.min.js"></script>
    <script src="vendors/scripts/selectivizr-master/selectivizr.js"></script>
    <script src="vendors/scripts/jquery.waypoints.min.js"></script>
